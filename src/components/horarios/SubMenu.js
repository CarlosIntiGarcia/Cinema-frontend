            ...
            <div className="schedule_sub_menu">
                    ...
                    <div className="date_times_values"> 
                        {
                            this.props.funciones.map(funcion =>{
                                if(funcion.v_tipo_funcion === "2D Doblada"){
                                    console.log(funcion.t_inicioproyeccion)
                                    return(
                                        <Horario 
                                            key={funcion.id}
                ...
                <div className="time_movie">
                    ...
                    <div className="date_times_values"> 
                        {
                            this.props.funciones.map(funcion =>{
                                if(funcion.v_tipo_funcion === "2D Subtitulada"){
                                    return(
                                        <Horario 
                                            key={funcion.id}
                                            hora={funcion.t_inicioproyeccion}
                ...
                <div className="time_movie">
                    ...
                    <div className="date_times_values"> 
                        {
                            this.props.funciones.map(funcion =>{
                                if(funcion.v_tipo_funcion === "3D Doblada"){
                                    return(
                                        <Horario 
                                            key={funcion.id}
                                            hora={funcion.t_inicioproyeccion}
                ...
                <div className="time_movie">
                    ...
                    <div className="date_times_values"> 
                        {
                            this.props.funciones.map(funcion =>{
                                if(funcion.v_tipo_funcion === "3D Subtitulada"){
                                    return(
                                        <Horario 
                                            key={funcion.id}
                                            hora={funcion.t_inicioproyeccion}
